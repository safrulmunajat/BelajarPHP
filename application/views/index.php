...
<meta name="keywords" content="elegant, web theme, free templates, website templates, CSS, HTML" />
<meta name="description" content="Elegant Theme is a free website template provided by tooplate.com" />
...
<div id="tooplate_wrapper">
	<div id="tooplate_header">
        <div id="site_title"><h1><a rel="nofollow" href="http://www.tooplate.com">Templates</a></h1></div>
    </div> <!-- end of forever header -->
    
    <div id="tooplate_menu">
        <ul>
            <li><a href="<?php echo base_url()."index.php/web"; ?>" class="current">Home</a></li>
